...
namespace sletat.ru.HotelServiceReference
{
    ...
    public interface IHotelService {
        ...
        sletat.ru.HotelServiceReference.Hotel GetHotel(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHotelService/GetHotel", ReplyAction="http://tempuri.org/IHotelService/GetHotelResponse")]
        System.Threading.Tasks.Task<sletat.ru.HotelServiceReference.Hotel> GetHotelAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IHotelServiceChannel : sletat.ru.HotelServiceReference.IHotelService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HotelServiceClient : System.ServiceModel.ClientBase<sletat.ru.HotelServiceReference.IHotelService>, sletat.ru.HotelServiceReference.IHotelService {
        ...
        public sletat.ru.HotelServiceReference.Hotel GetHotel(int id) {
            return base.Channel.GetHotel(id);
        }
        
        public System.Threading.Tasks.Task<sletat.ru.HotelServiceReference.Hotel> GetHotelAsync(int id) {
            return base.Channel.GetHotelAsync(id);
        }
    }
}
